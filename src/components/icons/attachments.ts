...
export class AttachmentsIcon extends Component<IncomingProps> {
  static componentName = "AttachmentsIcon";
  ...
  protected render(): string {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" class="{{className}}" width="22" height="22" viewBox="0 0 22 22">
