...
export class BigAvatarIcon extends Component<IncomingProps> {
  static componentName = "BigAvatarIcon";
  ...
  protected render(): string {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" class="{{className}}" width="40" height="40" viewBox="0 0 40 40">
